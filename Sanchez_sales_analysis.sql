...
-- Overall the sales in that product category are low, even though that category has the highest number of transactions. 
-- We could offer more advertising for our stationery and supplies, as well as hold promotions for that category. 
-- The Greenville store brought in $25,191.44 more in revenue then Charleston store. 
-- We can do more advertising for the Charleston store to bring in more customers.   
